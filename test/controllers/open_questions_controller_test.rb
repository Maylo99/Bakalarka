...
class OpenQuestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create open_question" do
    assert_difference("OpenQuestion.count") do
      post open_questions_url, params: { open_question: { correctAnswer: @open_question.correctAnswer, points: @open_question.points, question: @open_question.question, test_id: @open_question.test_id } }
    end
  ...
  test "should update open_question" do
    patch open_question_url(@open_question), params: { open_question: { correctAnswer: @open_question.correctAnswer, points: @open_question.points, question: @open_question.question, test_id: @open_question.test_id } }
