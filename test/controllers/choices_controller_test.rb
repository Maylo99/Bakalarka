...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference("Choice.count") do
      post choices_url, params: { choice: { answer: @choice.answer, is_true: @choice.is_true, partialPoints: @choice.partialPoints } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { answer: @choice.answer, is_true: @choice.is_true, partialPoints: @choice.partialPoints } }
